...
/**
 * The Employee class represents the "employee" table in the "empdb" schema of
...
@Entity // This annotation specifies that the class is an entity and is mapped to a
		// database table.
@Table(name = "employee", schema = "empdb") // Specifies the table name and schema in the database.
